...
@interface WalkRouteTableViewController ()<WalkChooseDelegate>
{
...
-(void)getWalkInfo{
    ...
    dic = @{@"UID":uid,@"pageIndex":index,@"pageSize":@20,@"Token":Token,@"DateCount":_datecount,@"FormPlatform":@100,@"ClientType":@10};
...
-(void)sendtime:(int)time{
    _datecount = [NSNumber numberWithInt:time];
    [self getWalkInfo];
}
@end
